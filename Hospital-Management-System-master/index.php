...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
    <div class="container">
      ...
      <a class="navbar-brand js-scroll-trigger" href="#" style="margin-top: 10px;margin-left:-30px;font-family: 'IBM Plex Sans', sans-serif;"><h4><i class="fa fa-user-plus" aria-hidden="true">
      </i>&nbsp PENDO MEDICAL CLINIC</h4></a>
...
<div class="container register" style="font-family: 'IBM Plex Sans', sans-serif;">
                <div class="row">
                    ...
                    <div class="col-md-9 register-right" style="margin-top: 5px;left: 30px;">
                                        ...
                                        <div class="form-group">
                                            <div class="maxl">
                                                <label class="radio inline"> 
                                                    <input type="radio" name="gender" value="Male" style="color: #07bc5e;" checked>
                                                    <span> Male </span> 
                                                </label>
                                                <label class="radio inline"> 
                                            ...
                                            <a href="index1.php" style="color: #07bc5e;">Already have an account?</a>
                                        </div>
                                    </div>
